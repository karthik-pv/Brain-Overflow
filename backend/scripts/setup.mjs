...
const REQUIRED = ['SUPABASE_PROJECT_REF','SUPABASE_URL','SUPABASE_SECRET_KEY','SUPABASE_PUBLISHABLE_KEY','TELEGRAM_BOT_TOKEN','AI_API_KEY','ENCRYPTION_KEY','TELEGRAM_ALLOWED_USERS']
...
const { SUPABASE_PROJECT_REF, SUPABASE_URL, SUPABASE_SECRET_KEY, TELEGRAM_BOT_TOKEN, AI_API_KEY, ENCRYPTION_KEY, TELEGRAM_ALLOWED_USERS } = process.env
