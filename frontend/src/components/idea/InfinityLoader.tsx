...
export function InfinityLoader({ size = 40, className }: InfinityLoaderProps) {
  return (
    <div role="status" aria-live="polite" className={cn('flex items-center justify-center', className)}>
      ...
      >
        <path
          className="stroke-[color:var(--color-edge)] opacity-40"
          fill="none"
          strokeWidth={4}
          pathLength={100}
        ...
        <path
          ...
          className="stroke-[color:var(--color-pivot)]"
          fill="none"
          strokeWidth={4}
